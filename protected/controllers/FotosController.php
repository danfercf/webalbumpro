...
/**
	...
	public function actionDelete($id)
	{
		if(Yii::app()->request->isPostRequest)
		{
			...
			$thumbPath = $pathInfo['dirname'] . '/thumb/' . $imgName;
			$regularPath = $pathInfo['dirname'] . '/regular/' . $imgName;
			
			// borrar thumb
	    	if (file_exists($thumbPath))
	    	{
	            @unlink($thumbPath);
	            echo "Thumb eliminado";
	    	}
	...
	{
		$model=Fotos::model()->findByPk((int)$id);
		if($model===null)
