<script>
    $(document).ready(function(){
       $('#Actualizar_idPais').change(function(){
            var value = $('#Actualizar_idPais option:selected').val();
            alert("Valor: "+value+"as: "+"<?php echo $this->createUrl('paises/provincias');?>");
            $.ajax({
              type: "POST",
...
<?php echo $form->errorSummary($model); ?>
    ...
    <div class="row">
        ...
        <?php echo $form->dropDownList($model,'idProvincia',array('empty'=>'--Por favor escoja--'),array('class'=>'formelement replacer','maxlength'=>50)); ?>
        
    </div>
    <!--SELECT localidad-->
    <div class="row">
		<?php echo $form->labelEx($model,'idLocalidad'); ?><br/>
        <?php echo $form->textField($model,'idLocalidad',array('class'=>'formelement longer','size'=>100,'maxlength'=>100)); ?>
    ...
    <div class="row_foto">
        ...
        <p>
        <a href="#"><img src="/images/photo.png" style="width: 100px; height: 100px; padding: 0 45px;"/></a>
        </p>
        <p>
        <?php //echo $form->labelEx($model,'foto'); ?><br/>
        <?php echo $form->fileField($model,'foto',array('class'=>'formelement longer','size'=>13,'maxlength'=>100)); ?>
        </p>
    </div>
