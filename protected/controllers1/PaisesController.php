...
class PaisesController extends Controller
{
	...
	public function accessRules()
	{
	   /*return array(
		...
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','view','delete','Provincias',),
				'users'=>array('@'),
			),
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
	...
	{
		$model=Paises::model()->findByPk((int)$id);
		if($model===null)
    ...
    public function actionProvincias() {
             $data=Provincias::model()->findAll('idProvincia=:parent_id',
             array(':parent_id'=>(int) $_POST['idPais']));

             $data=CHtml::listData($data,'idProvincia','nom_provincia');
