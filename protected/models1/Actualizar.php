...
class Actualizar extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('email, nombre, apellido, idPais, idProvincia, idLocalidad, direccion, telefono', 'required'), 
			...
			array('id, nombre, apellido, email, pass, fechaCreacion, idPais, token, registrado, idProvincia, idLocalidad, direccion, telefono, telefono2, url_web, url_blog, facebook, twitter, foto, info', 'safe', 'on'=>'search'),
		);
	}
